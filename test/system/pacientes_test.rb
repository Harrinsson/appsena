...
class PacientesTest < ApplicationSystemTestCase
  ...
  test "should create paciente" do
    ...
    fill_in "Correo", with: @paciente.correo
    fill_in "Direccion", with: @paciente.direccion
    fill_in "Fechanacido", with: @paciente.fechanacido
    fill_in "Identificacion", with: @paciente.identificacion
    fill_in "Nombre", with: @paciente.nombre
    fill_in "Sexo", with: @paciente.sexo
    fill_in "Telefono", with: @paciente.telefono
    fill_in "Tipoid", with: @paciente.tipoid
